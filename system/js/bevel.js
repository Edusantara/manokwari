function RunPustekkom() {
	Utils.run_command("exo-open --launch WebBrowser %u http://setjen.kemdikbud.go.id/pustekkom");
}
function RunSuaraEdukasi() {
	Utils.run_command("exo-open --launch WebBrowser %u http://suaraedukasi.kemdikbud.go.id");
}
function RunFacebook() {
	Utils.run_command("exo-open --launch WebBrowser %u https://facebook.com/pustekkom");
}
function RunTwitter() {
	Utils.run_command("exo-open --launch WebBrowser %u https://twitter.com/pustekkom");
}
